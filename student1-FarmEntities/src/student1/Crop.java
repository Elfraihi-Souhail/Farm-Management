...
public abstract class Crop {
    ...
    public Crop(String string, String string2, CropFamily cropFamily, LocalDate localDate, LocalDate localDate2, GrowthStage growthStage, double d, double d2, double d3, double d4) {
        this.id = string;
        this.name = string2;
